...
if (apiKey && merchantAddress) {
  app.use(
    ...
    createPincerPayMiddleware({
      ...
      merchantAddress,
      routes: {
        "GET /api/weather": { price: "0.001", chain: "solana-devnet", description: "Real-time weather data" },
        "GET /api/market-data": { price: "0.01", chain: "solana-devnet", description: "Live crypto market prices" },
        "GET /api/research": { price: "0.05", chain: "solana-devnet", description: "AI-generated research summary" },
        "GET /api/premium-analytics": { price: "0.10", chain: "solana-devnet", description: "Premium analytics dashboard" },
      },
    }),
  );
}
